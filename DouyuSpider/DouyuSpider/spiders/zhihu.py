...
from DouyuSpider.items import ZhihuQuestionItem, ZhihuAnswerItem
import re
import json
import datetime
...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        browser.find_element_by_css_selector(
            ".SignFlow-accountInput.Input-wrapper input[name='username']").send_keys("13814922947")
        browser.find_element_by_css_selector(".SignFlow-password input[name='password']").send_keys("zyqljcan1")
        #
        browser.find_element_by_css_selector(
            "button.Button.SignFlow-submitButton.Button--primary.Button--blue").click()
        import time
        time.sleep(10)
        ...
        for cookie in Cookies:
            ...
            f = open('/Users/purelove/PycharmProjects/DouyuSpider/DouyuSpider/cookie_dict' + cookie['name'] + '.zhihu','wb')
