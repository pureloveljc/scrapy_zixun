...
#             f=open('/Users/purelove/PycharmProjects/DouyuSpider/DouyuSpider/spiders' + cookie['name']+'.zhihu','wb')
#             pickle.dump(cookie,f)
#             f.close()
#             cookie_dict[cookie['name']] =cookie['value']
#         browser.close()
#         return [scrapy.Request(url=self.start_urls[0], headers=self.headers, dont_filter=True,cookie=cookie_dict, callback=self.login_after_captcha)
#
#
