...
back_color = imread('/Users/purelove/LjcSpider/music_fenxi/backgroud_img/shade.jpg')  # 解析该图片
...
wc = WordCloud(background_color='white',  # 背景颜色
               ...
               font_path="/Users/purelove/LjcSpider/music_fenxi/font/simhei.ttf",  # 解决显示口字型乱码问题，
...
#jieba.add_word('金三胖') 0

# 打开词源的文本文件
text = open('/Users/purelove/LjcSpider/music_fenxi/all_songs/song_liuxing/zonghe.txt').read()
...
plt.axis('off')
# 保存图片
wc.to_file('E:\ljcprojects\music_fenxi\\result.png')
